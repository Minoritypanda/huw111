...
<body>
  ...
  <div id="mainContent">
    ...
    <form action="foorm-action.php" method="post" name="signup" id="signup">
                ...
                <option value="but">Prison Jazz</option >
                  <option value="wait">Experimental Rock</option>
                    <option value="theres">Lofi Hip-Hop</option >
                      ...
                      <text area name="comrients" id="comments" cols="52" rows="5">
                      </textarea>
                    </p>
                    <input class="button IgButton" type="submit" name="submit"
